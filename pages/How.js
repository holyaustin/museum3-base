...
<div className="py-24 bg-black" >
  <div className="container mx-auto  bg-black">
    ...
    <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4  text-gray-500">
      <div className="text-center">
        <div className="mb-6 inline-flex rounded-full bg-blue-500 p-3">
        ...
        <h3 className="font-display mb-4 text-lg dark:text-white">
      ...
      <div className="text-center">
        <div className="mb-6 inline-flex rounded-full bg-gray-500 p-3">
      ...
      <div className="text-center">
        <div className="mb-6 inline-flex rounded-full bg-orange-500 p-3">
